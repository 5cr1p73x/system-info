...
from psutil import (cpu_percent, disk_partitions, disk_usage, pids,
                    virtual_memory, pid_exists, Process)
...
class App():
    ...
    def drawTaskListTab(self):

        '''Drawing task list tab'''

        # Task list tab and its widgets
        
        self.task_list_tab = self.drawTab("Task list")

        self.tasks_list = tk.Listbox(self.task_list_tab, font=("Consolas", 14), width=52, bg="#2C2C2C", fg="#62CA00")
